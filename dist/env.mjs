...
const server = zod_1.z.object({
    ...
    DISCORD_SECRET: zod_1.z.string(),
    GITHUB_ID: zod_1.z.string(),
    GITHUB_SECRET: zod_1.z.string(),
    GOOGLE_ID: zod_1.z.string(),
    GOOGLE_SECRET: zod_1.z.string(),
    LINKEDIN_ID: zod_1.z.string(),
    LINKEDIN_SECRET: zod_1.z.string(),
});
/**
...
if (!!process.env.SKIP_ENV_VALIDATION == false) {
    ...
    exports.env = env = new Proxy(parsed.data, {
        get(target, prop) {
